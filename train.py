...
#    print(word_map["a"]) -> 1
    ...
    for i, (image_input, word_inputs, word_targets, lengths, ids, captions, labels, *excess) in enumerate(val_data_loader):
...
def train(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    # Batches
#    for i, (imgs, caps, caplens) in enumerate(train_loader):
    for i, (imgs, word_inputs, word_targets, caplens, ids, caps, labels, *excess) in enumerate(train_loader):
